   ...
   <div class="swiper-wrapper">
      <div class="swiper-slide slide">
         <div class="image">
                ...
                <div class="content">
                    <h3>PC Gaming Corvus, AMD Ryzen 3 3200G 3.6GHz</h3>
                    <span>1670 lei</span><br>
                    <a href="quick_view.php?pid=82" class="btn">Cumpăra acum!</a>
                </div>
            </div>
            ...
            <div class="swiper-slide slide">
                ...
                <div class="content">
                    <h3>AMD Ryzen 9 7900X 4.7GHz</h3>
                    <span>2350 lei</span><br>
                    <a href="quick_view.php?pid=100" class="btn">Cumpăra acum!</a>
                </div>
            </div>
            ...
            <div class="swiper-slide slide">
                ...
                <div class="content">
                    <h3>Mouse Gaming Logitech G102 Lightsync RGB Black</h3>
                    <span>110 lei</span><br>
                    <a href="quick_view.php?pid=76" class="btn">Cumpăra acum!</a>
                </div>
            </div>
        </div>
...
<div class="swiper-wrapper">
            ...
            <a href="category.php?category=Smart%20TV" class="swiper-slide slide">
                <img src="images/icon-2.png" alt="">
                <h3>Smart TV</h3>
            </a>
            <a href="category.php?category=Cameră%20De%20Fotografiat" class="swiper-slide slide">
    ...
    <div class="swiper products-slider">
        ...
        ?>
            ...
            <?php
                    ...
                    echo '<p class="empty">Momentan, nu este niciun produs disponibil!</p>';
                }
            ?>
        </div>
        <div class="swiper-pagination"></div>
