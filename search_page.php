...
<h1 class="heading" style="padding-top: 3rem;">Căutare produse</h1>
<section class="search-form">
    <form action="" method="post">
        <input type="text" class="box" maxlength="100" placeholder="Căutați orice produs aici!" required name="search_box">
